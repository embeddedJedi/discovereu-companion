...
// ─── Adapter interface ──────────────────────────────────────────────────────
// Conforms to js/features/llm-adapter.js provider contract:
//   { id, label, send(messages, options, apiKey) → { content, raw, usage } }

export const id = 'groq';
export const label = 'Groq';

/**
 * send(messages, { jsonMode, signal, model }, apiKey)
 * Accepts standard chat messages: [{ role, content }, ...]
 */
